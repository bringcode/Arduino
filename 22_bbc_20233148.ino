...
#define _BANGBANG_RANGE    360  // duty up and down for bangbang control
...
float volt_to_distance(int a_value)
{
  ...
  return 614 + (-2.71 * a_value) + (4.53E-03 * a_value * a_value) + (-2.87E-06 * (pow(a_value, 3)));
}
